...
export default async function HalamanPutarUlang({ searchParams }: PageProps<"/putar-ulang">) {
    ...
    isi =
      emiten.status === "tidak_ada" ? (
        <div className="pu-empty" data-testid="tidak-ada">
          ...
          <p>
            Data kami memuat 107 emiten universe uji (18 dihapus dari bursa, 59 pemantauan khusus, 30 kontrol sehat)
            ditambah feed suspensi seluruh bursa 2018–2026. {kode} tidak ada di keduanya. Kami tidak menarik data
            baru secara otomatis — setiap penarikan memakai kredit dan diputuskan manusia.
          </p>
  ...
  return (
    <>
      ...
      <h2 className="pu-h2">Lihat rekamannya: tanda resmi sudah ada sebelum sahamnya berhenti diperdagangkan.</h2>
      <p className="pu-lede">
      ...
      <div className="pu-howto">
        <div>
          <b>1</b>
          <span>Ketik kode saham (4 huruf) atau klik contoh kasus nyata.</span>
        </div>
        <div>
          <b>2</b>
          <span>Geser slider waktu ke kiri untuk mundur ke masa lalu.</span>
        </div>
        <div>
          <b>3</b>
          <span>Lihat lampu dan daftar tanda: mana yang sudah kelihatan pada tanggal itu.</span>
        </div>
      </div>
      <Pencarian kode={kode} />
      {isi ?? (
