  ...
  return (
    <main className="mx-auto w-full max-w-[1200px] flex-1 px-6 pb-16 pt-6">
      ...
      <p className="mb-4 max-w-[70ch] text-[13.5px] text-ink-2">
        Tambahkan saham yang kamu pegang, pilih alarm yang aktif, lalu klik Cek sekarang. Alarm mengecek data resmi di server
        kami tanpa memakai <Istilah id="kredit_sectors">kredit</Istilah>; data terkini (broker,{" "}
        <Istilah id="free_float">free float</Istilah>, harga) hanya ditarik kalau kamu minta.
      </p>
      <PetunjukLayar
        langkah={[
